 ...
 * This program allows the control of Miriam over either USB serial port or web service wifi
 *
 ...
 * - LEDS: 22,2,12,11
 *
 * (c) 2015 Juho Terrijarvi, Miroculus
 *     Original Juanjo Tara, Arduino
 */
...
byte states[] = {INIT, CANCEL, HEAT_BOARDS, SENSOR_TEST, INFO, SET_TEMP_UPPER, SET_TEMP_MIDDLE, READ_ASSAY};
